...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const hackingId = result.insertId;
            ...
            for (const partecipante of tuttiPartecipanti) {
                await connection.execute(
                    ...
                    [hackingId, partecipante.discord_id, partecipante.discord_username, partecipante.ruolo]
                );
            }
            ...
            console.log("ID report salvato:", hackingId);
        } catch (error) {
